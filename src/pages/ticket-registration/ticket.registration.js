...
function TicketRegistration() {
  ...
  const handleOnSubmit = async () => {
    ...
    if (createdTicket && createdTicket._id) {
      enqueueSnackbar(
        MESSAGE_CONSTANTS.TICKET.TICKET_CREATED_WITH_SUCCESS(createdTicket._id),
        {
          variant: "success",
        }
      );
    ...
    enqueueSnackbar(MESSAGE_CONSTANTS.TICKET.ERROR_ON_CREATE_TICKET, {
      variant: "error",
    });
    return;
  };
                ...
                <FormControl fullWidth>
                  ...
                  >
                    {ticketTypes.map((ticketType) => (
                      <MenuItem value={ticketType} key={ticketType}>
                        {ticketType}
                      </MenuItem>
                    ))}
                  </Select>
